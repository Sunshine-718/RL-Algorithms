...
if __name__ == "__main__":
    ...
    ac = ContinuousSAC(1e-3, 1e-3, observation_space.shape[0],
                       256, action_space.shape[0], 1, 0, 0.2, 1e-2,
                       device=device)
    config = Config()
    agent = ContinuousSACAgent('bipedalwalker_sac_continuous', ac, config)
